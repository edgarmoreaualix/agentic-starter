# Task | Loop 008 | orch-01 -> worker-sentinel

## Goal
- Upgrade sentinel bug watch and hardening guidance for loop-008.

## Scope
- docs/placeholders/orch-01/loop-008-app/bug-watch.md
- docs/placeholders/orch-01/loop-008-app/hardening.md
- ops/loops/008/v2/orchestrators/orch-01/summaries/worker-sentinel.json
...
## Validation Command
- test -s docs/placeholders/orch-01/loop-008-app/bug-watch.md && test -s docs/placeholders/orch-01/loop-008-app/hardening.md && jq -e '.status=="done"' ops/loops/008/v2/orchestrators/orch-01/summaries/worker-sentinel.json
