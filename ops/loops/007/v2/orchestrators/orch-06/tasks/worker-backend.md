# Task | Loop 007 | orch-06 -> worker-backend

## Goal
- Build tiny backend app data for orch-06 (pink).

## Scope
- backend/placeholders/orch-06/loop-007-app/config.json
- backend/placeholders/orch-06/loop-007-app/api.json
- ops/loops/007/v2/orchestrators/orch-06/summaries/worker-backend.json
...
## Validation Command
- test -s backend/placeholders/orch-06/loop-007-app/config.json && test -s backend/placeholders/orch-06/loop-007-app/api.json && jq -e '.status=="done"' ops/loops/007/v2/orchestrators/orch-06/summaries/worker-backend.json
