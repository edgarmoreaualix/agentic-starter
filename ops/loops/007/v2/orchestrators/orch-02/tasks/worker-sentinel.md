# Task | Loop 007 | orch-02 -> worker-sentinel

## Goal
- Watch for bugs and document hardening notes for orch-02.

## Scope
- docs/placeholders/orch-02/loop-007-app/bug-watch.md
- docs/placeholders/orch-02/loop-007-app/hardening.md
- ops/loops/007/v2/orchestrators/orch-02/summaries/worker-sentinel.json
...
## Validation Command
- test -s docs/placeholders/orch-02/loop-007-app/bug-watch.md && test -s docs/placeholders/orch-02/loop-007-app/hardening.md && jq -e '.status=="done"' ops/loops/007/v2/orchestrators/orch-02/summaries/worker-sentinel.json
