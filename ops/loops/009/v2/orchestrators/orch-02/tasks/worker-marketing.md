# Task | Loop 009 | orch-02 -> worker-marketing
...
- docs/apps/orch-02-webapp/marketing-note.md
- ops/loops/009/v2/orchestrators/orch-02/summaries/worker-marketing.json
...
## Contract / Inputs
- Frontend must render `frontend/apps/orch-02-webapp/specialist.txt` exactly as specialist message.
...
## Validation Command
- test -s frontend/apps/orch-02-webapp/specialist.txt && test -s docs/apps/orch-02-webapp/marketing-note.md && wc -l frontend/apps/orch-02-webapp/specialist.txt
